...
public class Emporer extends AppCompatActivity {
    int num = 1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emporer);
        ...
        switch (n){
            case 1 :
                btn1.setImageResource(R.drawable.emperor);
                break;
            case 2 :
                btn2.setImageResource(R.drawable.emperor);
                break;
            case 3 :
                btn3.setImageResource(R.drawable.emperor);
                break;
            case 4 :
                btn4.setImageResource(R.drawable.emperor);
                break;
            case 5 :
                btn5.setImageResource(R.drawable.emperor);
                break;
        }
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btn1.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.citizen).getConstantState())) {
                    ...
                    imageView1.setImageResource(R.drawable.emperor);
                    Enter.flag1 = false;
                    Intent intent = new Intent(Emporer.this, End.class);
                ...
                if (enemy != num){
                    ...
                    imageView2.setImageResource(R.drawable.slave);
                    Enter.flag2 = false;
                    Intent intent = new Intent(Emporer.this, End.class);
                    startActivity(intent);
                }
